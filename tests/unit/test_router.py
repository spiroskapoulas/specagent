...
class TestRouterNode:
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_retrieve_decision(self, mock_hf_endpoint):
        ...
        mock_hf_endpoint.return_value = mock_llm
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_reject_decision(self, mock_hf_endpoint):
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_with_3gpp_question(self, mock_hf_endpoint):
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_with_5g_question(self, mock_hf_endpoint):
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_with_off_topic_question(self, mock_hf_endpoint):
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_preserves_other_state_fields(self, mock_hf_endpoint):
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_llm_call_format(self, mock_hf_endpoint):
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_handles_llm_error(self, mock_hf_endpoint):
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_uses_hf_hub_settings(self, mock_hf_endpoint):
        ...
        # Verify HuggingFaceEndpoint was initialized
        mock_hf_endpoint.assert_called_once()

    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_with_telecom_terminology(self, mock_hf_endpoint):
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_empty_question(self, mock_hf_endpoint):
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_whitespace_only_question(self, mock_hf_endpoint):
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_very_long_question(self, mock_hf_endpoint):
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_unicode_question(self, mock_hf_endpoint):
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_special_characters(self, mock_hf_endpoint):
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_mixed_content_question(self, mock_hf_endpoint):
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_error_sets_correct_fields(self, mock_hf_endpoint):
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_initialization_error(self, mock_hf_endpoint):
        """Test router handles LLM initialization errors."""
        mock_hf_endpoint.side_effect = Exception("Failed to initialize HuggingFaceEndpoint")
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_structured_output_error(self, mock_hf_endpoint):
    ...
    def test_router_uses_settings_correctly(self, mock_settings, mock_hf_endpoint):
        ...
        # Verify HuggingFaceEndpoint was called with correct settings
        mock_hf_endpoint.assert_called_once()
        call_kwargs = mock_hf_endpoint.call_args[1]
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_prompt_contains_question(self, mock_hf_endpoint):
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_state_not_modified_on_error(self, mock_hf_endpoint):
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_multiple_calls_independent(self, mock_hf_endpoint):
    ...
    @patch('specagent.nodes.router.HuggingFaceEndpoint')
    def test_router_missing_question_key(self, mock_hf_endpoint):
